...
int main(int argc, char** argv) {
    if(argc != 8 && argc != 9) {
        printf("Usage: rdma_client NET TEST HOST PORT CLIENTS ITERS PAYLOAD_SIZE [--print-all]\n");
        printf("\nNET:\n");
        ...
        printf("\n--print-all: must be specified at the end of all other arguments.\n");
        printf("\tIf specified, all results will be printed to stdout.\n");
        return 0;
    } else {
